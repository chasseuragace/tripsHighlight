...
class CardSavePlace extends StatelessWidget {
  ...
  bool useAsset;
  CardSavePlace(
      this.image, this.title, this.category, this.steps, this.marginTop,{this.useAsset=false});
    ...
    final card = Container(
      ...
      decoration: BoxDecoration(
          image: DecorationImage(
              fit: BoxFit.cover, image: useAsset? AssetImage(this.image): NetworkImage(this.image)),
